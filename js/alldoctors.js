...
function viewAllDoctors ()
{
  ...
  {
      container+=`  <div class=" col-lg-3 col-md-4 doctor-name ">

      <a href="#">
          <div class="bg-info mb-3 p-3 doctor-box">
              <div class="mb-3">
                  <img src =${allDoctors[i].photo} alt=doctor class="w-100">

              </div>
              <h4 class="text-white">${allDoctors[i].name}</h4>
              <h6 class=" text-white">اسم القسم</h6>
          </div>
      </a>
